...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3889b5a4c9509979e1b7d62f12d6f372) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Moore"; "Mealy"; "Types"; "Sigs"];
                      lib_pack = true;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Autos";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/tel/ocaml-autos";
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\016\235\177\030\025\1587$\167O\247|\186\222\191\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
